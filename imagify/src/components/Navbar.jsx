  ...
  return (
    ...
    <div>
        ...
        user ? <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <div className='relative group'>
                ...
                <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                    <ul className='list-none m-0 p-2 bg-white rounded-md boredr text-sm'>
                        <li onClick={logout}>
                            Logout
                        </li>
                    </ul>
        ...
        <div className='flex items-center gap-2 sm:gap-5'>
            ...
            <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 text-white px-7 py-2 sm:px-2 text-sm rounded-full cursor-pointer'>Login</button>
            </div>}
    </div>
