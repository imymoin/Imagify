...
const Login = () => {
  ...
  return (
    ...
    className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        {state !== 'Login' &&
            <div className='boredr px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.user_icon} alt="" />
            <input
            onChange={e =>{setName(e.target.value)}}
            value={name}
            className='outline-none text-sm' type="text" 
        ...
        <div className='boredr px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            ...
            value={email}
            className='outline-none text-sm' type="email" placeholder='Email' required />
        </div>
        <div className='boredr px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
